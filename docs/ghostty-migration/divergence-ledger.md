...
**v2 status:** obsolete — libghostty-vt now exposes `SCROLLBACK_MAX_LINES` / `set_scrollback_max_lines` natively (recon 5/6 §3, 6/6 §3); the bytes-over-pages conversion is deleted, not re-fired.
