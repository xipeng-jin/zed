...
///
/// ```rust
/// use ghostty_vt::{RenderState, Terminal, TerminalOptions};
///
...
/// # use ghostty_vt::{Terminal, TerminalOptions, RenderState, render::Dirty};
/// # let terminal = Terminal::new(TerminalOptions {
/// #     cols: 80,
/// #     rows: 25,
/// #     max_scrollback: 10000,
...
/// use ghostty_vt::render::CursorViewport;
/// # use ghostty_vt::{Terminal, TerminalOptions, RenderState};
/// # let terminal = Terminal::new(TerminalOptions {
/// #     cols: 80,
/// #     rows: 25,
...
/// use ghostty_vt::{Terminal, TerminalOptions, RenderState};
/// use ghostty_vt::style::Underline;
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
/// # let terminal = Terminal::new(TerminalOptions {
/// #     cols: 80,
    ...
    pub fn graphemes_utf8(&self, buf: &mut String) -> Result<()> {
        ...
        let cbuf = loop {
            ...
            match result {
                ...
                // NO_VALUE, INVALID_VALUE, and anything unexpected
                _ => {
